...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (_ingestedRouteArgs) return;

    final args = ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>?;
    final incoming = args?['newBooking'] as Map<String, dynamic>?;

    if (incoming != null) {
      final exists = history.any((e) =>
          e['shop'] == incoming['shop'] &&
          e['date'] == incoming['date'] &&
          e['time'] == incoming['time'] &&
          e['device'] == incoming['device']);

      if (!exists) {
        setState(() {
          history.insert(0, incoming);
        });
      }
    }

    _ingestedRouteArgs = true;
  }

  bool _ingestedRouteArgs = false;
...
// import 'package:flutter/material.dart'; ti 1 
...
// String _pad(int n) => n.toString().padLeft(2, '0');  ti 1 
